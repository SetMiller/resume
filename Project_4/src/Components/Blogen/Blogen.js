...
class Blogen extends React.Component {
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <NavDropdown title={titleIcon} id="basic-nav-dropdown" variant="danger">
            <NavDropdown.Item href="#action/3.1">
              <FontAwesomeIcon icon={faUserCircle}/> Profile (в разработке)
            </NavDropdown.Item>
            <NavDropdown.Item href="#action/3.2">
              <FontAwesomeIcon icon={faCog}/> Settings (в разработке)
            </NavDropdown.Item>
          </NavDropdown>
          <Nav >
            {/* FIXME: тут логаут функция */}
            <NavLink to="/login" className="nav-link" onClick={this.props.onLogoutHandler}>
